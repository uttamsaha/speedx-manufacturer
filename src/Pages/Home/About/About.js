...
const About = () => {
  return (
    <div class="hero min-h-screen bg-base-100 mt-[-100px]">
  <div class="hero-content flex-col lg:flex-row-reverse">
    <img src={img} className=" lg:max-w-xl sm:max-w-sm-sm xs:max-w-xs rounded-lg shadow-2xl lg:h-80" alt=''/>
    <div>
      <h1 className=" welcome-text xs:text-3xl lg:text-5xl sm:text-3xl  font-bold">Welcome To,</h1>
      <h1 className='welcome-text lg:text-5xl sm:text-3xl xs:text-3xl text-primary'>SpeedX Manufacturer</h1>
